...
msg = raw_input('> ')
if msg == '1':
    import discovery as pycmbs_discovery
    pycmbs_discovery.__init__
elif msg == '2':
    import broadcast.server as pycmbs_broadcast_server
    pycmbs_broadcast_server.__init__
elif msg == '3':
    import broadcast.client as pycmbs_broadcast_client
    pycmbs_broadcast_client.__init__
elif msg == '4':
    import for_provider.server as pycmbs_provider_server
    pycmbs_provider_server.__init__
elif msg == '5':
    import for_provider.client as pycmbs_provider_client
